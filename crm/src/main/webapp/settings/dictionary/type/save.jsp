	...
	<div style="position:  relative; left: 30px;">
		<h3>新增字典类型</h3>
	  	<div style="position: relative; top: -40px; left: 70%;">
			<button type="button" class="btn btn-primary" onclick="saveDicType()">保存</button>
			<button type="button" class="btn btn-default" onclick="window.history.back();">取消</button>
		</div>
		<hr style="position: relative; top: -40px;">
	</div>
	<%--创建字典类型--%>
	<form class="form-horizontal" role="form" id="dicTypeForm" method="post" action="${pageContext.request.contextPath}/dictionary/saveDicType.do">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<textarea class="form-control" name="describe" rows="3" id="describe" style="width: 200%;"></textarea>
			</div>
		</div>
	</form>
